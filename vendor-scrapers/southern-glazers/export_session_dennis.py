#!/usr/bin/env python3
"""
Southern Glazer's Session Export — Dennis
=========================================
...
Usage (from MobaXterm or ssh -Y):
    ...
    /opt/rednun/venv/bin/python3 export_session_dennis.py
...
STORAGE_STATE_FILE = Path("./storage_state_dennis.json")


def main():
    print("=" * 60)
    print("Southern Glazer's Session Export — DENNIS")
    print("=" * 60)
    print()
    ...
    print("  2. Log in as mgiorgio@rednun.com (Dennis)")
