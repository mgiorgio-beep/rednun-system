#!/usr/bin/env python3
"""
Martignetti Session Export — Red Nun Vendor Scrapers
...
def main():
    print("=" * 60)
    print("Martignetti Session Export")
    print("=" * 60)
    print()
    ...
    print()
    print("Instructions:")
    print("  1. A browser window will open to the Martignetti portal")
    print("  2. Log in with your credentials")
    print("  3. Wait for the invoice list to load")
    ...
    with sync_playwright() as p:
        ...
        print("Opening Martignetti portal...")
        page.goto(PORTAL_URL, wait_until="domcontentloaded", timeout=60000)

        print()
        print(">>> Browser is open. Log in, wait for invoices to load.")
